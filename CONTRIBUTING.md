# How to contribute to cozy-admin?
...
- What is the version of the cozy-admin app?
...
```
$ git clone github.com/cozy/cozy-admin.git
$ cd cozy-admin
$ git remote add fork git://github.com/yourusername/cozy-admin.git
```
...
Go to https://github.com/yourusername/cozy-admin and select your branch. Click the 'Pull Request' button and fill out the form.
...
The cozy-admin is translated on a platform called [Transifex][tx]. [This tutorial][tx-start] can help you to learn how to make your first steps here. If you have any question, don't hesitate to ask us!
...
[issues]: https://github.com/cozy/cozy-admin/issues/new
...
[localization]: https://github.com/cozy/cozy-admin/blob/master/README.md#localization
